...
<body>
    ...
    <script>
        ...
        function viewUser(userId) {
            ...
            // Example: window.location.href = '/admin/user/view/' + userId;
        }
        ...
        function updateUser(userId) {
            ...
            // Example: window.location.href = '/admin/user/edit/' + userId;
        }
        ...
        function deleteUser(userId) {
            ...
            if (confirm('Are you sure you want to delete this user?')) {
                ...
                // Example: window.location.href = '/admin/user/delete/' + userId;
            }
        }
